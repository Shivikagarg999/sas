...
import { FaChalkboardTeacher, FaUser, FaPhone, FaEnvelope, FaVenusMars, FaMapMarkerAlt, FaBook, FaGraduationCap, FaCalendarDay, FaMoneyBillWave, FaCheck } from 'react-icons/fa';
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-8 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    {errors.fullName && (
                      <p className="mt-1 text-sm text-rose-600">Full name is required</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    {errors.phone && (
                      <p className="mt-1 text-sm text-rose-600">Phone number is required</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  {errors.location?.city && (
                    <p className="mt-1 text-sm text-rose-600">City is required</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.location?.area && (
                    <p className="mt-1 text-sm text-rose-600">Area is required</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    {...register('location.pinCode', { required: true })}
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                    placeholder="e.g. 110001"
                  />
                  {errors.location?.pinCode && (
                    <p className="mt-1 text-sm text-rose-600">PIN code is required</p>
                  )}
                </div>
              </div>
            </div>
              ...
              {watch('subjects').map((subject, index) => (
                <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                  <div>
                    ...
                    <input
                      type="text"
                      {...register(`subjects.${index}.subject`, { required: true })}
                      className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                      placeholder="e.g. Mathematics"
                    />
                    {errors.subjects?.[index]?.subject && (
                      <p className="mt-1 text-sm text-rose-600">Subject is required</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      {...register(`subjects.${index}.classRange`, { required: true })}
                      className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                    >
                    ...
                    {errors.subjects?.[index]?.classRange && (
                      <p className="mt-1 text-sm text-rose-600">Class range is required</p>
                    )}
                  </div>
            ...
            <div className="pt-6">
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-pink-500 to-rose-500 text-white py-4 px-6 rounded-xl font-semibold text-lg hover:shadow-lg transition-all"
              >
                Submit Application
              </motion.button>
            </div>
